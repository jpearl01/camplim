...
prototypeMethods.save = function(fieldsNames, callback) {
  ...
  try {
    if (inserting) {
      ...
      // Instead, let's remove *all* null values.
      //
      ...
      //  Can't do this in Meteor because their Underscore version is old
      //
      // values = _.omit(values, function(value) {
      //   return _.isNull(value);
      // });
      //
      // So, instead, do it manually:
